...
from globalgenie.aws.context import AwsBuildContext
from globalgenie.infra.app import InfraApp
...
if TYPE_CHECKING:
    ...
    from globalgenie.aws.resource.ecs.container import EcsContainer
...
class AwsApp(InfraApp):
        ...
        container_env.update(
            {
                ...
                GLOBALGENIE_RUNTIME_ENV_VAR: "ecs",
    ...
    def get_load_balancer_security_groups(self) -> Optional[List["SecurityGroup"]]:
        from globalgenie.aws.resource.ec2.security_group import InboundRule, SecurityGroup
    ...
    def security_group_definition(self) -> "SecurityGroup":
        from globalgenie.aws.resource.ec2.security_group import InboundRule, SecurityGroup
        from globalgenie.aws.resource.reference import AwsReference
    ...
    def build_resources(self, build_context: AwsBuildContext) -> List["AwsResource"]:
        ...
        from globalgenie.aws.resource.ecs.service import EcsService
        from globalgenie.aws.resource.ecs.task_definition import EcsTaskDefinition
        from globalgenie.aws.resource.ecs.volume import EcsVolume
        from globalgenie.aws.resource.elb.listener import Listener
        from globalgenie.aws.resource.elb.load_balancer import LoadBalancer
        from globalgenie.aws.resource.elb.target_group import TargetGroup
        from globalgenie.docker.resource.image import DockerImage
        from globalgenie.utils.defaults import get_default_volume_name
