...
from globalgenie.aws.app.base import AwsApp
...
class AwsResources(InfraResources):
    ...
    def get_aws_region(self) -> Optional[str]:
        ...
        from globalgenie.constants import AWS_REGION_ENV_VAR
    ...
    def get_aws_profile(self) -> Optional[str]:
        ...
        from globalgenie.constants import AWS_PROFILE_ENV_VAR
    ...
    def create_resources(
        ...
        from globalgenie.aws.resource.types import AwsResourceInstallOrder
        from globalgenie.cli.console import confirm_yes_no, print_heading, print_info
