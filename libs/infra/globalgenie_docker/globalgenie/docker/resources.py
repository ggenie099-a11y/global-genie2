...
from globalgenie.docker.api_client import DockerApiClient
from globalgenie.docker.app.base import DockerApp
...
class DockerResources(InfraResources):
    ...
    def create_resources(
        ...
        from globalgenie.docker.resource.types import DockerContainer, DockerResourceInstallOrder
