...
VIRTUAL_ENV=${VENV_DIR} uv pip install -U globalgenie langgraph langchain_openai openai-agents crewai pydantic_ai smolagents autogen-agentchat "autogen-ext[openai]"
