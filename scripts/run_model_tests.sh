...
# Change to globalgenie directory
cd libs/globalgenie
...
# Install globalgenie with model and integration test dependencies
print_heading "Installing globalgenie with ${MODEL_NAME} dependencies"
