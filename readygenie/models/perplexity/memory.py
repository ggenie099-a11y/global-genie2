...
Steps:
1. Run: `./readygenie/scripts/run_pgvector.sh` to start a postgres container with pgvector
2. Run: `pip install openai sqlalchemy 'psycopg[binary]' pgvector` to install the dependencies
3. Run: `python readygenie/agents/personalized_memories_and_summaries.py` to run the agent
"""

from globalgenie.agent import Agent
from globalgenie.memory.v2.db.postgres import PostgresMemoryDb
from globalgenie.memory.v2.memory import Memory
from globalgenie.models.perplexity import Perplexity
