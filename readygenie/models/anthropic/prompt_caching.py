"""
This readygenie shows how to use prompt caching with Agents using Anthropic models, to catch the system prompt passed to the model.
...
download_file(
    "https://globalgenie-public.s3.amazonaws.com/prompts/system_promt.txt",
    str(txt_path),
)
