...
In this example, the agent uses the GlobalGenie documentation as a knowledge base

Key Features:
- Iteratively searches a knowledge base
- Source attribution and citations

Run `pip install openai lancedb tantivy inquirer globalgenie groq` to install dependencies.
"""
...
def initialize_knowledge_base():
    ...
    Here we use GlobalGenie docs as an example, but you can replace with any relevant URLs
    """
...
def get_example_topics() -> List[str]:
    ...
    return [
        "What are AI agents and how do they work in GlobalGenie?",
        "What chunking strategies does GlobalGenie support for text processing?",
        "How can I implement custom tools in GlobalGenie?",
        "How does knowledge retrieval work in GlobalGenie?",
        "What types of embeddings does GlobalGenie support?",
    ]
...
"""
Explore GlobalGenie's capabilities with these queries:
1. "What are the different types of agents in GlobalGenie?"
2. "How does GlobalGenie handle knowledge base management?"
3. "What embedding models does GlobalGenie support?"
4. "How can I implement custom tools in GlobalGenie?"
5. "What storage options are available for workflow caching?"
6. "How does GlobalGenie handle streaming responses?"
7. "What types of LLM providers does GlobalGenie support?"
