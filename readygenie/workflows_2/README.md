# GlobalGenie Workflows 2.0 - Developer Guide

Welcome to **GlobalGenie Workflows 2.0** - the next generation of intelligent, flexible workflow orchestration. This guide covers all workflow patterns, from simple linear sequences to complex conditional logic with parallel execution.
...
GlobalGenie Workflows 2.0 provides a powerful, declarative way to orchestrate multi-step AI processes. Unlike traditional linear workflows, you can now create sophisticated branching logic, parallel execution, and dynamic routing based on content analysis.

![Workflows 2.0 flow](/readygenie/workflows_2/assets/workflows_v2_flow.png)
...
The workflow system is built around the concept of atomic execution units in GlobalGenie- `Agents` and `Teams`, these are individual components that can work independently but gain enhanced capabilities when orchestrated together:
...
```python
from globalgenie.workflow.v2 import Step, Workflow
...
**See Examples**: 
- [`sequence_of_functions_and_agents.py`](/readygenie/workflows_2/sync/01_basic_workflows/sequence_of_functions_and_agents.py)
- [`sequence_of_functions_and_agents_stream.py`](/readygenie/workflows_2/sync/01_basic_workflows/sequence_of_functions_and_agents_stream.py)


> **Note**: `StepInput` and `StepOutput` provides standardized interfaces for data flow between steps:
![Workflows Step IO](/readygenie/workflows_2/assets/step_io_flow.png)
...
**See Examples**:
- [`function_instead_of_steps.py`](/readygenie/workflows_2/sync/01_basic_workflows/function_instead_of_steps.py) - Complete function-based workflow
- [`function_instead_of_steps_stream.py`](/readygenie/workflows_2/sync/01_basic_workflows/function_instead_of_steps_stream.py) - Streaming version
...
**You can name your steps** for better logging and future support on the GlobalGenie platform:
...
**See Examples**: 
- [`sequence_of_steps.py`](readygenie/workflows_2/sync/01_basic_workflows/sequence_of_steps.py)
- [`sequence_of_steps_stream.py`](readygenie/workflows_2/sync/01_basic_workflows/sequence_of_steps_stream.py)
- [`step_with_function.py`](/readygenie/workflows_2/sync/01_basic_workflows/step_with_function.py)
- [`step_with_function_stream.py`](/readygenie/workflows_2/sync/01_basic_workflows/step_with_function_stream.py)
...
![Parallel Steps](/readygenie/workflows_2/assets/parallel_steps.png)

```python
from globalgenie.workflow.v2 import Parallel, Step, Workflow
...
**See Examples**: 
- [`parallel_steps_workflow.py`](/readygenie/workflows_2/sync/04_workflows_parallel_execution/parallel_steps_workflow.py)
- [`parallel_steps_workflow_stream.py`](/readygenie/workflows_2/sync/04_workflows_parallel_execution/parallel_steps_workflow_stream.py)
...
![Condition Steps](/readygenie/workflows_2/assets/condition_steps.png)

```python
from globalgenie.workflow.v2 import Condition, Step, Workflow
...
**See Examples**: 
- [`condition_with_list_of_steps.py`](/readygenie/workflows_2/sync/02_workflows_conditional_execution/condition_with_list_of_steps.py)
- [`condition_steps_workflow_stream.py`](/readygenie/workflows_2/sync/02_workflows_conditional_execution/condition_steps_workflow_stream.py)
...
![Loop Steps](/readygenie/workflows_2/assets/loop_steps.png)

```python
from globalgenie.workflow.v2 import Loop, Step, Workflow
...
**See Examples**: 
- [`loop_steps_workflow.py`](/readygenie/workflows_2/sync/03_workflows_loop_execution/loop_steps_workflow.py)
- [`loop_steps_workflow_stream.py`](/readygenie/workflows_2/sync/03_workflows_loop_execution/loop_steps_workflow_stream.py)
...
![Router Steps](/readygenie/workflows_2/assets/router_steps.png)

```python
from globalgenie.workflow.v2 import Router, Step, Workflow
...
**See Examples**: 
- [`router_steps_workflow.py`](/readygenie/workflows_2/sync/05_workflows_conditional_branching/router_steps_workflow.py)
- [`router_steps_workflow_stream.py`](/readygenie/workflows_2/sync/05_workflows_conditional_branching/router_steps_workflow_stream.py)
...
```python
from globalgenie.workflow.v2 import Steps, Step, Workflow
...
```python
from globalgenie.workflow.v2 import Steps, Router, Step, Workflow
...
**See Examples**
- [`workflow_using_steps.py`](/readygenie/workflows_2/sync/01_basic_workflows/workflow_using_steps.py)
- [`workflow_using_steps_nested.py`](/readygenie/workflows_2/sync/01_basic_workflows/workflow_using_steps_nested.py)
- [`selector_for_image_video_generation_pipelines.py`](/readygenie/workflows_2/sync/05_workflows_conditional_branching/selector_for_image_video_generation_pipelines.py)
...
```python
from globalgenie.workflow.v2 import Condition, Loop, Parallel, Router, Step, Workflow
...
**See Examples**: 
- [`condition_and_parallel_steps_stream.py`](/readygenie/workflows_2/sync/02_workflows_conditional_execution/condition_and_parallel_steps_stream.py)
- [`loop_with_parallel_steps_stream.py`](/readygenie/workflows_2/sync/03_workflows_loop_execution/loop_with_parallel_steps_stream.py)
- [`router_with_loop_steps.py`](/readygenie/workflows_2/sync/05_workflows_conditional_branching/router_with_loop_steps.py)
...
![Early Stop Workflows](/readygenie/workflows_2/assets/early_stop.png)
...
**See Examples**: 
- [`early_stop_workflow_with_agents.py`](/readygenie/workflows_2/sync/06_workflows_advanced_concepts/early_stop_workflow_with_agents.py)
- [`early_stop_workflow_with_loop.py`](/readygenie/workflows_2/sync/06_workflows_advanced_concepts/early_stop_workflow_with_loop.py)
- [`early_stop_workflow_with_router.py`](/readygenie/workflows_2/sync/06_workflows_advanced_concepts/early_stop_workflow_with_router.py)
...
```python
from globalgenie.run.v2.workflow import WorkflowRunEvent
...
**See Examples**:
- [`store_events_and_events_to_skip_in_a_workflow.py`](/readygenie/workflows_2/sync/06_workflows_advanced_concepts/store_events_and_events_to_skip_in_a_workflow.py)
...
**See**: [`step_with_function_additional_data.py`](/readygenie/workflows_2/sync/01_basic_workflows/step_with_function_additional_data.py)
...
```python
from globalgenie.workflow.v2 import Workflow
...
**See**: 
- [`shared_session_state_with_agent.py`](/readygenie/workflows_2/sync/06_workflows_advanced_concepts/shared_session_state_with_agent.py)
- [`shared_session_state_with_team.py`](/readygenie/workflows_2/sync/06_workflows_advanced_concepts/shared_session_state_with_team.py)
...
**See**: [`pydantic_model_as_input.py`](/readygenie/workflows_2/sync/06_workflows_advanced_concepts/pydantic_model_as_input.py)
...
For more examples and advanced patterns, explore the [`readygenie/workflows/sync/`](/readygenie/workflows_2/sync) and [`readygenie/workflows/async/`](/readygenie/workflows_2/async) directory. Each file demonstrates a specific pattern with detailed comments and real-world use cases.
