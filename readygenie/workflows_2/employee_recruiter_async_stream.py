...
from globalgenie.workflow.v2.types import WorkflowExecutionInput
...
email_writer_agent = Agent(
    ...
    instructions=[
        ...
        "Sign emails as 'John Doe, Senior Software Engineer' with email john@globalgenie.com",
    ],
    ...
    asyncio.run(
        recruitment_workflow.aprint_response(
            ...
            candidate_resume_urls=[
                "https://globalgenie-public.s3.us-east-1.amazonaws.com/demo_data/filters/cv_1.pdf",
                "https://globalgenie-public.s3.us-east-1.amazonaws.com/demo_data/filters/cv_2.pdf",
            ],
            job_description="""
