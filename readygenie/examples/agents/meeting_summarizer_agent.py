...
Requires: pip install openai globalgenie
"""
...
from globalgenie.utils.media import download_file, save_base64_data

input_audio_url: str = (
    "https://globalgenie-public.s3.us-east-1.amazonaws.com/demo_data/sample_audio.mp3"
)
