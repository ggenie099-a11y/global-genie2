...
def generate_podcast(topic, voice="alloy"):
    """
    Generates a podcast script using a globalgeniedata Agent and converts it to speech using OpenAI TTS.
    ...
    # Create a globalgeniedata agent to generate the podcast script
    audio_agent = Agent(
        ...
        instructions="""### **Instructions:**
            ...
            "Imagine walking into a hospital where AI instantly diglobalgenieses your illness, prescribes treatment, and even assists in surgery. Sounds like science fiction? Well, it's closer to reality than you think! Welcome to today's episode, where we explore how AI is revolutionizing healthcare."

            "AI is making waves in medical research, diglobalgeniestics, and patient care. For instance, Google's DeepMind developed an AI that can detect over 50 eye diseases with a single scan—just as accurately as top doctors! Meanwhile, robotic surgeries assisted by AI are reducing complications and recovery time for patients. But it's not just about tech—AI is also addressing healthcare accessibility. In rural areas, AI-powered chatbots provide medical advice where doctors are scarce."

            "While AI in healthcare is promising, it also raises ethical concerns. Who takes responsibility for a wrong diglobalgeniesis? How do we ensure data privacy? These are crucial questions for the future. One thing's for sure—AI is here to stay, and it's reshaping medicine as we know it. Thanks for tuning in, and see you next time!"
            """,
        model=OpenAIChat(
