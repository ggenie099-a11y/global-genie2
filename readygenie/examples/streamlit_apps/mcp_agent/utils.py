...
def example_inputs(server_id: str) -> None:
    ...
    with st.sidebar:
        ...
        if server_id == "github":
            if st.button("Tell me about GlobalGenie"):
                add_message(
                    "user",
                    "Tell me about GlobalGenie. Github repo: https://github.com/globalgenie-agi/globalgenie. You can read the README for more information.",
                )
            if st.button("Find issues in the GlobalGenie repo"):
                add_message(
                    "user",
                    "Find open issues in the globalgenie-agi/globalgenie repository and summarize the top 3 most recent ones.",
                )
...
def about_widget() -> None:
    ...
    st.sidebar.markdown(
        ...
        Built with:
        - 🚀 [GlobalGenie](https://github.com/globalgenie-agi/globalgenie)
...
def apply_theme():
    ...
    st.set_page_config(
        page_title="GlobalGenie Universal MCP Agent",
