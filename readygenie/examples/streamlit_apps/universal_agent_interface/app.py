...
from globalgenie.run.response import RunEvent
...
nest_asyncio.apply()
st.set_page_config(
    page_title="GlobalGenie Universal Agent Interface",
    page_icon="🌟",
    layout="wide",
...
async def header():
    st.markdown(
        "<h1 class='heading'>GlobalGenie Universal Agent Interface</h1>", unsafe_allow_html=True
    )
    st.markdown(
        "<p class='subheading'>Orchestrate intelligent AI agents with advanced reasoning and collaboration</p>",
