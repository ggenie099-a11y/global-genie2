...
from globalgenie.document.reader import Reader
...
from globalgenie.memory.v2 import Memory, UserMemory
...
async def example_inputs() -> None:
    ...
    with st.sidebar:
        ...
        if st.button("Analyze a CSV file"):
            await add_message(
                "user",
                "Analyze this CSV file and show me the most popular movies: https://globalgenie-public.s3.amazonaws.com/demo_data/IMDB-Movie-Data.csv",
            )

        if st.button("Translate a sentence into emojis"):
            await add_message(
                "user",
                "Write a Python function that translates a given sentence into emojis, replacing words like “happy,” “sad,” “pizza,” and “party” with relevant emojis. Test it with the sentence: “I am happy because I am learning to build agents with GlobalGenie”",
            )
...
async def about_globalgenie():
    """Show information about GlobalGenie in the sidebar"""
    with st.sidebar:
        st.markdown("### About GlobalGenie ✨")
        st.markdown("""
        **GlobalGenie** is a comprehensive framework for building sophisticated AI agents with memory, reasoning, and multi-modal capabilities.
        ...
        [GitHub](https://github.com/globalgenie-agi/globalgenie) | [Documentation](https://docs.globalgenie.com)
        """)

        st.markdown("### Need Help? 🤝")
        st.markdown(
            "Join our community for support and discussions:\n"
            "- [Discord](https://globalgenie.link/discord) - Real-time chat\n"
            "- [Community Forum](https://globalgenie.link/community) - Q&A and discussions"
        )
