...
st.set_page_config(
    page_title="GlobalGenie Deep Research Agent",
    page_icon="🔎",
    layout="wide",
...
with open(
    "readygenie/examples/streamlit_apps/deep_researcher/assets/scrapegraph.png", "rb"
) as scrapegraph_file:
    ...
    <div style="display: flex; justify-content: center; align-items: center; width: 100%; padding: 32px 0 24px 0;">
        <h1 style="margin: 0; padding: 0; font-size: 2.5rem; font-weight: bold;">
            ...
            <span style="color: #fb542c;">GlobalGenie</span> & 
...
with st.sidebar:
    st.image(
        "readygenie/examples/streamlit_apps/deep_researcher/assets/nebius.png", width=150
    )
