...
from globalgenie.media import Image as GlobalGenieImage
from medical_agent import agent
from PIL import Image as PILImage

st.set_page_config(
    page_title="GlobalGenie Medical Imaging Analysis",
    page_icon="🏥",
    layout="wide",
)
...
def main():
    ...
    st.title("🏥 Medical Imaging Diglobalgeniesis Agent")
            ...
            if analyze_button:
                ...
                with st.spinner("🔄 Analyzing image... Please wait."):
                    try:
                        ...
                        globalgenie_image = GlobalGenieImage(content=image_bytes, format="png")
                        ...
                        response = agent.run(prompt, images=[globalgenie_image])
