...
nest_asyncio.apply()
st.set_page_config(
    page_title="GlobalGenie SQrL: Text2SQL Reasoning Agent",
    page_icon="💎",
    layout="wide",
...
def main() -> None:
    ...
    st.markdown(
        "<p class='subtitle'>SQrL is an intelligent SQL Agent that can think, analyze and reason, powered by GlobalGenie</p>",
        unsafe_allow_html=True,
    )
