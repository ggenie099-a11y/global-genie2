"""
1. Install dependencies using: `pip install openai globalgenie`
2. Run the script using: `python readygenie/examples/streamlit/game_generator/game_generator.py`
"""
...
from globalgenie.run.workflow import WorkflowCompletedEvent
from globalgenie.storage.workflow.sqlite import SqliteWorkflowStorage
from globalgenie.utils.log import logger
from globalgenie.utils.pprint import pprint_run_response
from globalgenie.utils.string import hash_string_sha256
from globalgenie.utils.web import open_html_file
from globalgenie.workflow import Workflow
