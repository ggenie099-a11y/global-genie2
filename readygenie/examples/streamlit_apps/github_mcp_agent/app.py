...
# Page config
st.set_page_config(page_title="GlobalGenie 🐙 GitHub MCP Agent", page_icon="🐙", layout="wide")
...
with col1:
    repo = st.text_input("Repository", value="globalgenie-agi/globalgenie", help="Format: owner/repo")
with col2:
...
if "result" not in locals():
    st.markdown(
        ...
        <ol>
            ...
            <li>Specify a repository (e.g., globalgenie-agi/globalgenie)</li>
...
# Footer
st.markdown("---")
st.write("Built with Streamlit, GlobalGenie, and Model Context Protocol ❤️")
