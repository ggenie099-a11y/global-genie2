...
customer_support_team.print_response(
    "Hi Team, I want to build an educational platform where the models are have access to tons of study materials, How can GlobalGenie platform help me build this?",
    stream=True,
)
# customer_support_team.print_response(
