"""GlobalGenie Assist - Your Assistant for GlobalGenie Framework!

Install dependencies: `pip install openai lancedb tantivy elevenlabs sqlalchemy globalgenie`
"""
...
if __name__ == "__main__":
    ...
    globalgenie_assist.print_response("Tell me about the GlobalGenie framework", stream=True)
