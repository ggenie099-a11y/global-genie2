...
Install dependencies: `pip install openai lancedb tantivy sqlalchemy globalgenie`
"""
...
if __name__ == "__main__":
    ...
    agent_with_storage.print_response("Tell me about the GlobalGenie framework", stream=True)
