...
Run `pip install openai duckduckgo-search newspaper4k lxml_html_clean sqlalchemy globalgenie` to install dependencies.
"""
...
from globalgenie.workflow import RunResponse, Workflow
...
if __name__ == "__main__":
    ...
    generate_blog_post = BlogPostGenerator(
        ...
        storage=SqliteStorage(
            ...
            db_file="tmp/globalgenie_workflows.db",
        ),
    )
