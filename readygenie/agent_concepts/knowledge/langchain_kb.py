"""
pip install langchain langchain-community langchain-openai langchain-chroma globalgenie
"""

import pathlib

from globalgenie.agent import Agent
from globalgenie.knowledge.langchain import LangChainKnowledgeBase
