...
Setup Steps:
1. Install required libraries: globalgenie, google-cloud-storage, psycopg2-binary (for PostgreSQL vector DB).
...
from globalgenie.knowledge.gcs.pdf import GCSPDFKnowledgeBase
