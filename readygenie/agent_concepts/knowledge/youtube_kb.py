...
from globalgenie.knowledge.youtube import YouTubeKnowledgeBase, YouTubeReader
from globalgenie.vectordb.qdrant import Qdrant

api_key = getenv("QDRANT_API_KEY")
qdrant_url = getenv("QDRANT_URL")

vector_db = Qdrant(collection="youtube-globalgenie", url=qdrant_url, api_key=api_key)
