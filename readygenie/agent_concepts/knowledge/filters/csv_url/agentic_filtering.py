...
knowledge_base = CSVUrlKnowledgeBase(
    urls=[
        {
            "url": "https://globalgenie-public.s3.us-east-1.amazonaws.com/demo_data/filters/filters_1.csv",
            "metadata": {
                "data_type": "sales",
                "quarter": "Q1",
                "year": 2024,
        ...
        {
            "url": "https://globalgenie-public.s3.us-east-1.amazonaws.com/demo_data/filters/filters_2.csv",
            "metadata": {
                "data_type": "sales",
                "year": 2024,
                "region": "europe",
