...
This readygenie demonstrates how to use knowledge filters with PDF documents accessed via URLs,
...
knowledge_base = PDFUrlKnowledgeBase(
    urls=[
        {
            "url": "https://globalgenie-public.s3.amazonaws.com/recipes/thai_recipes_short.pdf",
            "metadata": {
                "cuisine": "Thai",
                "source": "Thai ReadyGenie",
                "region": "Southeast Asia",
            },
        },
        {
            "url": "https://globalgenie-public.s3.amazonaws.com/recipes/cape_recipes_short_2.pdf",
            "metadata": {
                "cuisine": "Cape",
                "source": "Cape ReadyGenie",
                "region": "South Africa",
            },
        },
    ],
