...
Steps:
1. Run: `pip install openai sqlalchemy globalgenie` to install dependencies
2. Run: `python readygenie/agents/memories_and_summaries_sqlite.py` to run the agent
"""

import asyncio
import json

from globalgenie.agent import Agent, AgentMemory
from globalgenie.memory.db.sqlite import SqliteMemoryDb
