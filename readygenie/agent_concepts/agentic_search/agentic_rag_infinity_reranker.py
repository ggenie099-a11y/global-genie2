"""This readygenie shows how to implement Agentic RAG using Infinity Reranker.
...
Run: `pip install globalgenie anthropic infinity-client lancedb`
...
### 4. Run the Example
```bash
python readygenie/agent_concepts/agentic_search/agentic_rag_infinity_reranker.py
```
...
from globalgenie.reranker.infinity import InfinityReranker
from globalgenie.vectordb.lancedb import LanceDb, SearchType

# Create a knowledge base, loaded with documents from a URL
knowledge_base = UrlKnowledge(
    urls=[
        "https://docs.globalgenie.com/introduction/agents.md",
        "https://docs.globalgenie.com/agents/tools.md",
        "https://docs.globalgenie.com/agents/knowledge.md",
    ],
    # Use LanceDB as the vector database, store embeddings in the `globalgenie_docs_infinity` table
    vector_db=LanceDb(
        uri="tmp/lancedb",
        table_name="globalgenie_docs_infinity",
