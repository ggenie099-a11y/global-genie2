"""This readygenie shows how to implement Agentic RAG using Hybrid Search and Reranking.
...
3. Run: `python readygenie/agent_concepts/agentic_search/agentic_rag.py` to run the agent
"""
