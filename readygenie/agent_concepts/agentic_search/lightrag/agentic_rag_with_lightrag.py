...
from globalgenie.knowledge.light_rag import LightRagKnowledgeBase, lightrag_retriever
...
knowledge_base = LightRagKnowledgeBase(
    ...
    urls=["https://docs.globalgenie.com/introduction/agents.md"],  # Load documents from a URL
)
...
asyncio.run(agent.aprint_response("What are GlobalGenie Agents?"))
