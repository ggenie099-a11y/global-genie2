...
from globalgenie.memory.v2.db.firestore import FirestoreMemoryDb
...
agent_storage = FirestoreStorage(
    ...
    collection_name="globalgenie_sessions",
)
memory_db = FirestoreMemoryDb(
    db_name="memory", project_id="forward-vial-458917-s8", collection_name="globalgenie_memory"
)
