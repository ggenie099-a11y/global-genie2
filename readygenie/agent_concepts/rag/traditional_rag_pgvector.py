...
2. Run: `pip install openai sqlalchemy 'psycopg[binary]' pgvector globalgenie` to install the dependencies
3. Run: `python readygenie/rag/01_traditional_rag_pgvector.py` to run the agent
"""
