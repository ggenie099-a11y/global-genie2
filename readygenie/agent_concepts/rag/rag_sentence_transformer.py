"""This readygenie is an implementation of Agentic RAG using Sentence Transformer Reranker with multilingual data.

## Setup Instructions:

### 1. Install Dependencies
Run: `pip install globalgenie sentence-transformers`

### 2. Start the Postgres Server with pgvector
Run: `sh readygenie/scripts/run_pgvector.sh`

### 3. Run the example
Run: `uv run readygenie/agent_concepts/rag/rag_sentence_transformer.py`
"""

from globalgenie.agent import Agent
from globalgenie.embedder.sentence_transformer import SentenceTransformerEmbedder
from globalgenie.knowledge.document import DocumentKnowledgeBase
from globalgenie.models.openai import OpenAIChat
from globalgenie.reranker.sentence_transformer import SentenceTransformerReranker
