"""
1. Run: `pip install openai lancedb tantivy pypdf sqlalchemy globalgenie` to install the dependencies
2. Run: `python readygenie/rag/03_traditional_rag_lancedb.py` to run the agent
"""
