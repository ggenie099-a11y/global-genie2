...
This example demonstrates how to use GlobalGenie's agent to create a Hacker News content using the Stagehand MCP server.
...
- Install dependencies: pip install globalgenie mcp
- Set environment variables: BROWSERBASE_API_KEY, BROWSERBASE_PROJECT_ID, OPENAI_API_KEY
- Run this example: python readygenie/tools/mcp/stagehand.py
"""
