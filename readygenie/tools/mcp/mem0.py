...
This example demonstrates how to use GlobalGenie's MCP integration together with Mem0, to build a personalized code reviewer.

- Run your Mem0 MCP server. Full instructions: https://github.com/mem0ai/mem0-mcp
- Run: `pip install globalgenie mcp` to install the dependencies
"""
