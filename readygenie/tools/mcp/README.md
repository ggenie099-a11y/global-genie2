# MCP Agents using GlobalGenie

Model Context Protocol (MCP) gives Agents the ability to interact with external systems through a standardized interface. Using GlobalGenie's MCP integration, you can build Agents that can connect to any MCP-compatible service.
...
These examples use GlobalGenie to create agents that leverage MCP servers. The MCP servers provide standardized access to different data sources (filesystem, GitHub), and the agents use these servers to answer questions and perform tasks.
...
- Read about [GlobalGenie's MCP integration](https://docs.globalgenie.com/tools/mcp)
