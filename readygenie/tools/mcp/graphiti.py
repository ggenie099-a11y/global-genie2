...
This example demonstrates how to use GlobalGenie's MCP integration together with Graphiti, to build a personal diary assistant.

- Run your Graphiti MCP server. Full instructions: https://github.com/getzep/graphiti/tree/main/mcp_server
- Run: `pip install globalgenie mcp openai` to install the dependencies
"""
...
if __name__ == "__main__":
    asyncio.run(
        ...
        run_agent(
            "Add the following entry to the diary: 'Today I spent some time building agents with GlobalGenie'"
        )
    )
