...
This example shows how to use Pipedream MCP servers (in this case the Slack one) with GlobalGenie Agents.
...
4. Install dependencies: pip install globalgenie mcp
...
from globalgenie.utils.log import log_exception
...
if __name__ == "__main__":
    ...
    asyncio.run(
        run_agent("Send a message to <YOUR_NAME> saying 'Hello, I'm your GlobalGenie Agent!'")
    )
