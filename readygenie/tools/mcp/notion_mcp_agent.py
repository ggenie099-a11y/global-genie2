...
This example shows how to use the GlobalGenie MCP tools to interact with your Notion workspace.
...
Dependencies: pip install globalgenie mcp openai

Usage:
  python readygenie/tools/mcp/notion_mcp_agent.py
"""
