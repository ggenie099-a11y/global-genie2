...
agent.print_response("https://docs.globalgenie.com/introduction", markdown=True)
...
custom_agent.print_response("https://docs.globalgenie.com/introduction", markdown=True)
