...
from globalgenie.tools.mlx_transcribe import MLXTranscribeTools

# Get audio files from storage/audio directory
globalgenie_root_dir = Path(__file__).parent.parent.parent.resolve()
audio_storage_dir = globalgenie_root_dir.joinpath("storage/audio")
