...
from globalgenie.tools.x import XTools
...
agent = Agent(
    instructions=[
        "Use your tools to interact with X (Twitter) as the authorized user @GlobalGenieAgi",
...
# agent.print_response(
#     "Can you retrieve information about this user https://x.com/GlobalGenieAgi ",
#     markdown=True,
# )

# # Example usage: Reply To a Post
# agent.print_response(
#     "Can you reply to this [post ID] post as a general message as to how great this project is: https://x.com/GlobalGenieAgi",
#     markdown=True,
# )

# # Example usage: Send a direct message
# agent.print_response(
#     "Send direct message to the user @GlobalGenieAgi telling them I want to learn more about them and a link to their community.",
#     markdown=True,
# )
