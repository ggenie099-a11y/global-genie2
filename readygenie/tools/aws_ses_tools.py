...
from globalgenie.tools.aws_ses import AWSSESTool
...
agent = Agent(
    ...
    instructions=[
        ...
        "5. Send the email using AWS SES. IMPORTANT: The receiver_email parameter must be the COMPLETE email address including the @ symbol and domain (e.g., if the user says 'send to mustafa@globalgenie.com', you must use receiver_email='mustafa@globalgenie.com', NOT 'mustafacom' or any other variation).",
    ],
    tools=[
        AWSSESTool(
...
agent.print_response(
    "Research AI developments in healthcare from the past week with a focus on practical applications in clinical settings. Send the summary via email to mustafa@globalgenie.com"
)
