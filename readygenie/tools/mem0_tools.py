"""
This example demonstrates how to use the Mem0 toolkit with GlobalGenie agents.
...
from globalgenie.tools.mem0 import Mem0Tools

USER_ID = "jane_doe"
SESSION_ID = "globalgenie_session"
