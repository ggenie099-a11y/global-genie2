...
from globalgenie.tools.brightdata import BrightDataTools
...
agent.print_response(
    "Scrape this webpage as markdown: https://docs.globalgenie.com/introduction",
)

# Example 2: Take a screenshot of a webpage
# agent.print_response(
#     "Take a screenshot of this webpage: https://docs.globalgenie.com/introduction",
# )

# response = agent.run_response
# if response.images:
#     save_base64_data(response.images[0].content, "tmp/globalgenie_screenshot.png")
