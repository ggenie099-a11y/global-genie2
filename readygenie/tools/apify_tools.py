...
1. Install required dependencies:
   pip install globalgenie langchain-apify apify-client
...
def demonstrate_tools():
    ...
    prompt = "Carefully extract the key introduction details from https://docs.globalgenie.com/introduction"  #  Extract content from specific website
