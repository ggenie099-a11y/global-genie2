...
This example shows how to use GlobalGenie's Daytona integration to run Agent-generated code in a remote, secure sandbox.
...
3. Install the dependencies:
    pip install globalgenie anthropic daytona
"""

from globalgenie.agent import Agent
from globalgenie.tools.daytona import DaytonaTools
