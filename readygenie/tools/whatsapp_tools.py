...
This readygenie demonstrates how to use WhatsApp integration with GlobalGenie. Before running this example,
...
The example below shows how to send a template message using GlobalGenie's WhatsApp tools.
