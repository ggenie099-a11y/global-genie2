...
from globalgenie.tools.crawl4ai import Crawl4aiTools
...
agent.print_response(
    "Give me a detailed summary of the GlobalGenie project from https://github.com/globalgenie-agi/globalgenie and what are its main features?"
)
