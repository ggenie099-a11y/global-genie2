...
This example demonstrates how to use GlobalGenie's EVM integration to send ETH transactions
...
3. Install dependencies:
    pip install globalgenie web3
"""

from globalgenie.agent import Agent
from globalgenie.tools.evm import EvmTools
