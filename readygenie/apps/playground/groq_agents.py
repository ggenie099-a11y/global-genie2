"""Usage:
1. Install libraries: `pip install groq duckduckgo-search yfinance pypdf sqlalchemy 'fastapi[standard]' youtube-transcript-api globalgenie`
2. Run the script: `python readygenie/playground/groq_agents.py`
"""
