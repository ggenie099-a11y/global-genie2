"""Usage:
1. Install libraries: `pip install openai duckduckgo-search yfinance pypdf sqlalchemy 'fastapi[standard]' youtube-transcript-api globalgenie`
2. Run the script: `python readygenie/playground/grok_agents.py`
"""
