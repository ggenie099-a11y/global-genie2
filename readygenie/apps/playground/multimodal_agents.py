"""
1. Install dependencies: `pip install openai sqlalchemy 'fastapi[standard]' globalgenie requests`
2. Authenticate with globalgenie: `globalgenie setup`
3. Run the agent: `python readygenie/playground/multimodal_agent.py`

Docs on Agent UI: https://docs.globalgenie.com/agent-ui
"""
...
from globalgenie.tools.fal import FalTools
from globalgenie.tools.giphy import GiphyTools
