"""🤖 GlobalGenie Assist - Your AI Assistant for GlobalGenie Framework!
...
You can either use the "GlobalGenieAssist" agent or the "GlobalGenieAssistVoice" agent.
...
globalgenie_support = Agent(
    ...
    storage=SqliteStorage(
        table_name="globalgenie_assist_sessions",
...
globalgenie_support_voice = Agent(
...
playground = Playground(
    agents=[globalgenie_support, globalgenie_support_voice],
    app_id="globalgenie-assist-playground-app",
    name="GlobalGenie Assist Playground",
)
...
if __name__ == "__main__":
    ...
    playground.serve(app="globalgenie_assist:app", reload=True)
