"""Run `pip install openai exa_py duckduckgo-search yfinance pypdf sqlalchemy 'fastapi[standard]' youtube-transcript-api python-docx globalgenie` to install dependencies."""
...
from globalgenie.tools.thinking import ThinkingTools
...
if __name__ == "__main__":
    asyncio.run(globalgenie_docs.aload(recreate=True))
